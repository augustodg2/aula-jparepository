package dev.augusto.aulajparepository.controllers;
...
import dev.augusto.aulajparepository.repositories.UserRepository;
...
public class UserController {
	...
	public ResponseEntity<Page<User>> searchByName(@RequestParam(defaultValue = "") String name, Pageable pageable) {
		Page<User> result = repository.findByNameContainsIgnoreCase(name, pageable);
		return ResponseEntity.ok(result);
	}
}
